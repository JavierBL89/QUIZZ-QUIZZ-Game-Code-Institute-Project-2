...
for(let button of buttons){
  ...
  for(var i = 0;i< randomQuestion; i++){
    document.getElementById("question").textContent = generalLevel1[i].question;
    document.getElementById("answer1").textContent = generalLevel1[i].answer1;
    document.getElementById("answer2").textContent = generalLevel1[i].answer2;
    document.getElementById("answer3").textContent = generalLevel1[i].answer3;
  }
   ...
   function checkAnswer(answer){
     const desable = document.getElementsByClassName("desable");
...
function incrementScore(){
  ...
  let currentScore = document.getElementById("score").innerText = initialScore + 300;

}

function missedScored(){
  let initialScore = parseInt(document.getElementById("missed-score").innerText);
  let currentScore = document.getElementById("missed-score").innerText = initialScore - 300;
}
function incrementCorrectAnswers(){
  let initialNumber = parseInt(document.getElementById("correct").innerText);
  let currentNumber = document.getElementById("correct").innerText = ++initialNumber;

}

function incrementIncorrectAnswers(){
  let initialNumber = parseInt(document.getElementById("incorrect").innerText);
  let currentNumber = document.getElementById("incorrect").innerText = ++initialNumber;
